...
namespace NNParticleSystemGenerator
{
    ...
    {
        public static Mesh GetPrimitiveMeshAssetRef(PrimitiveType primitiveType)
        {
            return AssetDatabaseHelper.LoadAssetFromUniqueAssetPath<Mesh>("Library/unity default resources::" +
